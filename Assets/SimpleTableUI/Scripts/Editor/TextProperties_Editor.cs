...
namespace UnityEngine.UI.TableUI
{
    ...
    public class TextProperties_Editor : Editor
    {
        ...
        private void Alignment()
        {
            ...
            if (((_HorizontalAlignmentOptions)textAlignment.intValue & _HorizontalAlignmentOptions.Justified) == _HorizontalAlignmentOptions.Justified || ((_HorizontalAlignmentOptions)textAlignment.intValue & _HorizontalAlignmentOptions.Flush) == _HorizontalAlignmentOptions.Flush)
            {
                EditorGUI.BeginChangeCheck();
